...
folder = "../../downloads/QS_data/qs_l2b_v4p1/"
wfolder = "../../downloads/QS_data/"
...
for task in taskListInMe:
    ...
    lat = taskList[task][0]
    lon = taskList[task][1]
    cmd = f'python selectQuikSCATdataWithLatLon2.py --folder={folder} --wfolder={wfolder} --lat={lat} --lon={lon}'
    print(cmd)
    os.system(cmd)
