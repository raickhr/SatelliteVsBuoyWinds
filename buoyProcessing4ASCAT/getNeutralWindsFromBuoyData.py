...
for task in taskListInMe:
    ...
    if os.path.isfile(bWinds):
        ...
        writeFname = f'../../downloads/Buoy/extractedGZ2/WINDS/T_{lat:02d}{latUnits}_{lon:03d}{lonUnits}_COARE3p5_2007.nc'
        ...
        timeList = wind_dateTimeArr +rh_dateTimeArr +sst_dateTimeArr +airt_dateTimeArr
        timeList.sort()
