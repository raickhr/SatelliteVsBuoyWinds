...
def match_times(ds_sat, ds_buoy, 
    ...
    ds_sat_sel = ds_sat.isel(AS_TIME=list(idx_sat))
    ...
    ds_buoy_sel = ds_buoy_sel.rename({'TAO_TIME': 'AS_TIME'})
    ds_buoy_sel['AS_TIME'] = ds_sat_sel['AS_TIME'].to_numpy()
    ds_buoy_sel['TAO_TIME'] = xr.DataArray(TAO_TIME, dims=['AS_TIME'])
...
def process_matchup(lat, lon):
    ...
    output_filename = f'T_{coord_str}_COARE3p5_2013_2020_2hrMeanVar_AS_Matchup.nc'
