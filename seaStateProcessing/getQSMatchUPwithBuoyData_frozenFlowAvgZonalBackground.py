...
def process_matchup(lat, lon):
    ...
    buoySatMatchup_filename = f'T_{coord_str}_COARE3p5_1999_2009_2hrMeanVar_QS_Matchup_fz_zonal.nc'
    buoySatMatchup_file = BUOY_DIR / METOP_DIR/ buoySatMatchup_filename

    output_filename = f'T_{coord_str}_COARE3p5_1999_2009_2hrMeanVar_QS_Buoy_fz_zonal_Glorys_Wave_Matchup.nc'
