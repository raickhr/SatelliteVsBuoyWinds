...
def plotScatter(x,y,ax, xlabel, ylabel, fsize=20, color = 'blue', alpha=0.5, giveYlim=True, ylim=[-180,180]):
...
def printFig(lat, lon):
    ...
    if not os.path.isfile(matchFileName):
        ...
        text = f'{lat:d}{latUnits} {lon:d}{lonUnits} 10min-matchup buoy Neutral Winds with QS data 2000 to 2007'
