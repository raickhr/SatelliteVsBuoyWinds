...
fileList = glob('/srv/data2/srai_poseidon/srai_poseidon/observation/SatelliteVsBuoy/downloads/Buoy/extractedGZ/WINDS/*_xrr_COARE3p5_2000.nc')
...
for i in range(startIndices[rank], endIndices[rank]):
    ...
    vars = ['WSPD', 'WSPD_10N', 'SST', 'AIRT', 'RELH', 'U10N_x', 'U10N_y', 'cosWDIR', 'sinWDIR']
