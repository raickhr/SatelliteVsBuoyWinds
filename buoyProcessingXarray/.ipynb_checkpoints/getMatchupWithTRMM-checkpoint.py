...
def main():
    ...
    for latLon in taskListInMe:
        ...
        if os.path.isfile(bFile):
            writeFname = f'../../downloads/TRMM_data/TRMM_byTAOpos/T_{lat:02d}{latUnits}_{lon:03d}{lonUnits}_xrr_MatchUp_TRMM_2000.nc'
            ...
            allDS = xr.merge((ds_TRMM, ds_TAO))

            allDS.to_netcdf(writeFname, unlimited_dims='TRMM_TIME')
